package com.zkcgw.wwarcv.fragments;
...
import com.zkcgw.wwarcv.mods.location.LocationPickerActivity;
import com.zkcgw.wwarcv.ui.theme.ThemeCustomizerActivity;
...
public class FeaturesFragment extends Fragment {
    ...
    private final BroadcastReceiver prefsReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("com.zkcgw.wwarcv.ACTION_SEND_PREFS".equals(intent.getAction())) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            try (InputStream is = requireContext().getContentResolver().openInputStream(uri);
                ...
                while (keys.hasNext()) {
                    ...
                    if (val instanceof Boolean) {
                        ...
                        Intent intent = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF");
        ...
        locationPickerLauncher = registerForActivityResult(
                new ActivityResultContracts.StartActivityForResult(), result -> {
                    ...
                    Intent b1 = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF_STRING");
                    b1.putExtra("key", "spoofLat");
                    b1.putExtra("value", String.valueOf(lat));
                    requireContext().sendBroadcast(b1);

                    Intent b2 = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF_STRING");
        ...
        dirPickerLauncher = registerForActivityResult(new ActivityResultContracts.OpenDocumentTree(), uri -> {
            if (uri != null) {
                ...
                Intent intentUri = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF_STRING");
                intentUri.putExtra("key", "downloaderCustomUri");
                intentUri.putExtra("value", uriString);
                requireContext().sendBroadcast(intentUri);

                Intent intentPath = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF_STRING");
    ...
    private void pickQuality(int current) {
        ...
        new MaterialAlertDialogBuilder(requireContext())
                ...
                .setSingleChoiceItems(labels, sel, (dialog, which) -> {
                    ...
                    Intent b = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF_INT");
    ...
    private void backupSettings() {
        try {
            ...
            exportIntent.setComponent(new ComponentName(requireContext(), "com.zkcgw.wwarcv.mods.devops.config.JsonExportActivity"));
    ...
    private void importDevConfig() {
        ...
        importIntent.setComponent(new ComponentName(requireContext(), "com.zkcgw.wwarcv.mods.devops.config.JsonImportActivity"));
    ...
    private void exportDevConfig() {
        BroadcastReceiver configReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                Intent exportIntent = new Intent();
                exportIntent.setComponent(new ComponentName(activity, "com.zkcgw.wwarcv.mods.devops.config.JsonExportActivity"));
                exportIntent.putExtra("json_content", json);
                startActivity(exportIntent);
            }
        };
        IntentFilter filter = new IntentFilter("com.zkcgw.wwarcv.ACTION_SEND_CONFIG");
        ...
        Intent request = new Intent("com.zkcgw.wwarcv.ACTION_EXPORT_CONFIG");
        ...
        new AlertDialog.Builder(requireContext())
                ...
                .setPositiveButton(getString(R.string.ig_dialog_yes), (dialog, which) -> {
                    try (InputStream is = requireContext().getAssets().open("default_mc_overrides.json");
                        ...
                        Intent broadcast = new Intent("com.zkcgw.wwarcv.ACTION_IMPORT_CONFIG");
    ...
    public void onResume() {
        super.onResume();
        IntentFilter filter = new IntentFilter("com.zkcgw.wwarcv.ACTION_SEND_PREFS");
        if (Build.VERSION.SDK_INT >= 33) {
        ...
        requireContext().sendBroadcast(new Intent("com.zkcgw.wwarcv.ACTION_REQUEST_PREFS"));
    }
