package com.zkcgw.wwarcv.ui.theme;
...
import com.zkcgw.wwarcv.mods.ui.theme.IgThemePalette;
import com.zkcgw.wwarcv.mods.ui.theme.ThemePreset;
import com.zkcgw.wwarcv.mods.ui.theme.ThemePresets;
import com.zkcgw.wwarcv.mods.ui.theme.ThemeSettingsHelper;
...
public class ThemeCustomizerActivity extends AppCompatActivity implements AdvancedColorPickerDialog.Listener {
    ...
    private void persist() {
        ...
        Intent enabledIntent = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF");
        enabledIntent.putExtra("key", KEY_ENABLED);
        enabledIntent.putExtra("value", enabled);
        sendBroadcast(enabledIntent);

        Intent presetIntent = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF_INT");
        presetIntent.putExtra("key", KEY_PRESET_ID);
        presetIntent.putExtra("value", presetId);
        sendBroadcast(presetIntent);

        Intent paletteIntent = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF_STRING");
