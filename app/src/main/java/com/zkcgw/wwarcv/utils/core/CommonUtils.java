...
public class CommonUtils {
    ...
    public static final String MY_PACKAGE_NAME = "com.zkcgw.wwarcv";

    // In-app log viewer IPC
    public static final String ACTION_REQUEST_LOGS = "com.zkcgw.wwarcv.ACTION_REQUEST_LOGS";
    public static final String ACTION_LOGS_REPLY = "com.zkcgw.wwarcv.ACTION_LOGS_REPLY";
    public static final String ACTION_CLEAR_LOGS = "com.zkcgw.wwarcv.ACTION_CLEAR_LOGS";
