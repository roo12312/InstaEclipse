package com.zkcgw.wwarcv.mods.location;
...
public class LocationPickerActivity extends AppCompatActivity {
    ...
    private void persistCoords(double lat, double lng) {
        ...
        Intent latIntent = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF_STRING");
        ...
        Intent lngIntent = new Intent("com.zkcgw.wwarcv.ACTION_UPDATE_PREF_STRING");
