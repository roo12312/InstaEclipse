package com.zkcgw.wwarcv.mods.ui;

import static org.luckypray.dexkit.query.FindMethod.create;
import static com.zkcgw.wwarcv.mods.ghost.ui.GhostEmojiManager.addGhostEmojiNextToInbox;
...
import com.zkcgw.wwarcv.mods.ui.utils.BottomSheetHookUtil;
import com.zkcgw.wwarcv.mods.ui.utils.VibrationUtil;
import com.zkcgw.wwarcv.utils.core.SettingsManager;
import com.zkcgw.wwarcv.utils.dialog.DialogUtils;
...
import com.zkcgw.wwarcv.utils.toast.CustomToast;
    ...
    public static void registerConfigImportReceiver(android.content.Context context) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.TIRAMISU) {
            context.registerReceiver(receiver,
                    new IntentFilter("com.zkcgw.wwarcv.ACTION_IMPORT_CONFIG"),
    ...
    public static void registerSettingsRestoreReceiver(android.content.Context context) {
        BroadcastReceiver receiver = new BroadcastReceiver() {
            ...
            public void onReceive(android.content.Context ctx, Intent intent) {
                ...
                new Thread(() -> {
                    try {
                        com.zkcgw.wwarcv.utils.backup.SettingsBackupManager.fromJson(json);
                        SettingsManager.saveAllFlags();
                        com.zkcgw.wwarcv.utils.feature.FeatureManager.refreshFeatureStatus();
        ...
        try {
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.TIRAMISU) {
                context.registerReceiver(receiver,
                        new IntentFilter("com.zkcgw.wwarcv.ACTION_RESTORE_SETTINGS"),
                        android.content.Context.RECEIVER_EXPORTED);
            } else {
                androidx.core.content.ContextCompat.registerReceiver(context,
                        receiver,
